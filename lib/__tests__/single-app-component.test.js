...
describe('Single AppComponent', function () {
  describe('appState access', function () {
    ...
    var AccessRoot = function (_RootAppComponent) {
      ...
      _createClass(AccessRoot, [{
        key: 'render',
        value: function render() {
          return _react2.default.createElement(AccessApp, null);
        }
      }]);
    ...
    it('can set and retrieve appState', function () {
      var test = _reactTestRenderer2.default.create(_react2.default.createElement(AccessRoot, null));
      _assert.strict.deepEqual(test.toJSON().children, ['0']);
      var button = test.root.findByType('button');
      button.props.onClick();
      _assert.strict.deepEqual(test.toJSON().children, ['1']);
    });
  });
  ...
  describe('lifecycle', function () {
    ...
    var LifeCycleRoot = function (_RootAppComponent2) {
      ...
      _createClass(LifeCycleRoot, [{
        ...
        value: function render() {
          ...
          return _react2.default.createElement(LifeCycleApp, Object.assign({ ref: function ref(n) {
    ...
    var MoreSelectiveLifecycleRoot = function (_LifeCycleRoot) {
      ...
      _createClass(MoreSelectiveLifecycleRoot, [{
        ...
        value: function render() {
          ...
          return _react2.default.createElement(MoreSelectiveLifecycle, Object.assign({ ref: function ref(n) {
    ...
    describe('shouldComponentUpdate', function () {
      it('is called on change:props', function () {
      ...
      it('is called on change:state', function () {
      ...
      it('is called on change:appState', function () {
        var test = _reactTestRenderer2.default.create(_react2.default.createElement(LifeCycleRoot, null));
        var button = test.root.findByType('button');
        button.props.onClick();
        var logs = test.root.findByType(LifeCycleApp).instance.logs.filter(function (log) {
    ...
    describe('componentDidMount', function () {
      it('is called on mount', function () {
        var test = _reactTestRenderer2.default.create(_react2.default.createElement(LifeCycleRoot, null));
        var logs = test.root.findByType(LifeCycleApp).instance.logs.filter(function (log) {
    ...
    describe('componentDidUpdate', function () {
      ...
      it('is only called if shouldComponentUpdate => true', function () {
        var test = _reactTestRenderer2.default.create(_react2.default.createElement(MoreSelectiveLifecycleRoot, { p: 1 }));
        var getLogs = function getLogs() {
          return test.root.findByType(MoreSelectiveLifecycle).instance.logs.filter(function (log) {
            return log.method === 'componentDidUpdate';
          });
        };
        _assert.strict.deepEqual(getLogs(), []);

        test.update(_react2.default.createElement(MoreSelectiveLifecycleRoot, { p: 2 }));
        _assert.strict.deepEqual(getLogs(), []);
