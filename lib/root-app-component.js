...
var _appStateContext2 = _interopRequireDefault(_appStateContext);
...
var RootAppComponent = function (_React$Component) {
  _inherits(RootAppComponent, _React$Component);

  function RootAppComponent(props) {
    _classCallCheck(this, RootAppComponent);

    var _this = _possibleConstructorReturn(this, (RootAppComponent.__proto__ || Object.getPrototypeOf(RootAppComponent)).call(this, props));

    _this.__AppComponentProxy = (0, _proxyLifecycleMethodsFor2.default)(_this);
    _this.render = RootAppComponent.prototype.render;
  ...
  _createClass(RootAppComponent, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        _appStateProvider2.default,
        {
          appState: this.appState,
          getDerivedAppState: this.constructor.getDerivedAppState
        },
        React.createElement(
          _appStateContext2.default.Consumer,
          null,
          function (_ref) {
...
exports.default = RootAppComponent;